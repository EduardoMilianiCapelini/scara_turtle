...
"""autogenerated by genpy from Project/mouvementActionFeedback.msg. Do not edit."""
import sys
...
class mouvementActionFeedback(genpy.Message):
  ...
  _type = "Project/mouvementActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','Project/mouvementFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = Project.msg.mouvementFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = Project.msg.mouvementFeedback()
