...
"""autogenerated by genpy from Project/mouvementActionResult.msg. Do not edit."""
import sys
...
class mouvementActionResult(genpy.Message):
  ...
  _type = "Project/mouvementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','Project/mouvementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = Project.msg.mouvementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = Project.msg.mouvementResult()
