...
"""autogenerated by genpy from scara_cpe_kinemaics/mouvementActionFeedback.msg. Do not edit."""
import sys
...
class mouvementActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "scara_cpe_kinemaics/mouvementActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','scara_cpe_kinemaics/mouvementFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mouvementActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = scara_cpe_kinemaics.msg.mouvementFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = scara_cpe_kinemaics.msg.mouvementFeedback()
