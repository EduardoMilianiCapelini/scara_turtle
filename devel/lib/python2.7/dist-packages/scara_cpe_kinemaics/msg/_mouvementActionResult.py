...
"""autogenerated by genpy from scara_cpe_kinemaics/mouvementActionResult.msg. Do not edit."""
import sys
...
class mouvementActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "scara_cpe_kinemaics/mouvementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','scara_cpe_kinemaics/mouvementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mouvementActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = scara_cpe_kinemaics.msg.mouvementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = scara_cpe_kinemaics.msg.mouvementResult()
